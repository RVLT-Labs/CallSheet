  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-8 md:px-8">
      <div className="mb-6">
        ...
        <h1 className="font-display mb-1 text-2xl font-bold italic text-burgundy">{shoot.title ?? "Shoot"}</h1>
        <p className="text-[13px] text-ink-soft">
          {dateRangeLabel(shoot.dayIsos)} · {where}
        </p>
        {shoot.locationMapUrl && (
          <a href={shoot.locationMapUrl} target="_blank" rel="noreferrer" className="text-[12px] font-semibold text-burgundy">
            Open map
          </a>
        )}
